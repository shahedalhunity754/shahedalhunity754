...
## 📂 Featured projects :
- **(https://github.com/shahedalhunity754/DevOps-learning-journey):** My main laboratory where I document my journey , Linux commands , and networking labs.
- ## 🎯 Goals for 2024-2025 :
- Master bash scripting & python for Automation
- Get AWS Certified Cloud Practitioner
- learn Docker & Kubernetes
- - -
## 📮 Let's connect:
-**LinkedIn:** (https://www.linkedin.com/in/shahed-al-hunity-5a452b327?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app)
-**Email:** shahedalhunity754@gmail.com
---
*"Automaion is the key to efficiency."*💻✨
